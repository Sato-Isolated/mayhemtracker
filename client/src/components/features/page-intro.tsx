...
export function PageIntro({ eyebrow, title, description, actions }: PageIntroProps) {
  return (
    <section className="page-intro-shell panel-surface relative overflow-hidden px-[1.35rem] py-[1.25rem] rounded-[1.6rem] max-sm:px-4 max-sm:py-4 max-sm:pt-[1.1rem]">
