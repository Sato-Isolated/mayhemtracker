...
export function PageIntro({ eyebrow, title, description, actions }: PageIntroProps) {
  ...
  return (
    <section className="panel-surface relative overflow-hidden rounded-[1.2rem] px-4 py-3.5 max-sm:px-3.5 max-sm:py-3">
      ...
      <div className="relative z-[1] flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0 max-w-3xl">
          ...
          <h1 className="mt-1.5 text-[1.45rem] font-semibold tracking-[-0.03em] text-foreground md:text-[1.65rem]">{title}</h1>
