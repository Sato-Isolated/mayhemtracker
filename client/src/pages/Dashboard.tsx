...
export function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="dashboard-hero panel-surface p-4" data-testid="dashboard-hero">
        <div className="dashboard-hero-copy">
          ...
          <div className="dashboard-hero-chips mt-3">
            <span className="status-chip status-chip-strong">{overview.totalMatches} tracked matches</span>
            <span className="status-chip">{recentSession.matches} games on the last 24h</span>
            <span className="status-chip">{streakLabel}</span>
          </div>
          <div className="dashboard-hero-copy-grid mt-4">
            <div className="dashboard-hero-copy-card surface-soft rounded-[1rem] p-4">
        ...
        <div className="dashboard-hero-snapshot">
          <div className="dashboard-hero-card surface-elevated">
          ...
          <div className="dashboard-hero-spotlight surface-soft rounded-[1rem] p-4">
        ...
        <div className="dashboard-hero-heatmap">
        ...
        <Card data-testid="dashboard-recent-matches-card">
          ...
          <CardContent className="space-y-3">
            {recentMatches.length ? recentMatches.map((entry) => {
              ...
              return (
                <Link key={entry.match.matchId} to={`/history/${entry.match.matchId}`} className="dashboard-match-row surface-subtle block rounded-[1.2rem] p-4 transition hover:border-primary/40 hover:bg-accent/25">
